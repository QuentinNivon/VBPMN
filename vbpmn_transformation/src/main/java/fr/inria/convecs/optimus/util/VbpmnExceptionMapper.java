...
public class VbpmnExceptionMapper {
	...
	protected VbpmnExceptionMapper()
	{
	 ...
	 /**
     * Exception handler for the client requests which are operation specific
     * and resource specific.
     * 
     * @param exception Specifies the application exception type
     * @return WebApplicationException
     */

    public static WebApplicationException createWebAppException(
