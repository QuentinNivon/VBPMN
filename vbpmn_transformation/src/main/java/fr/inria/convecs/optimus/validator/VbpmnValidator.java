...
public class VbpmnValidator implements ModelValidator {
	...
	private static final String SCRIPTS_FOLDER = AppProperty.getInstance().getValue("SCRIPTS_PATH");

	private static final String OUTPUT_FOLDER = AppProperty.getInstance().getValue("OUTPUT_PATH");
