...
public class ValidationService {
  ...
  private static final String TRANSFORM_LOCATION = AppProperty.getInstance()
      .getValue("TRANSFORM_LOCATION");
  ...
  private File parseAndTransform(File input) {
    try {
      ...
      String outputFileName = new StringBuilder().append(TRANSFORM_LOCATION)
