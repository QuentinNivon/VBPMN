...
public class ValidationService {
  ...
  private static final String INPUT_PATH = AppProperty.getInstance().getFolder("INPUT_PATH");
  ...
  private File parseAndTransform(File input) {
    try {
      ...
      String outputFileName = new StringBuilder().append(OUTPUT_PATH).append(File.separator)
