...
public class Test29 extends GenericTest
{
	...
	private static final String PIF_FILE_1 = "Process_8T.pif"; //Balanced inclusive gateway inside a loop => should work
	private static final String PIF_FILE_2 = "Process_8T.pif";
